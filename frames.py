...
class Frames:
    ...
    def __init__(self, mainObj, MainWin, wWidth, wHeight, function, Object, xAxis=10, yAxis=10):
        ...
        self.btnClose = tkinter.Button(self.winFrame, text="Close" ,command=lambda: self.quitProgram(self.MainWindow),font=("Times New Roman",10,'bold'),width=20,bg="gray",fg='white',padx=5,pady=5,borderwidth=1,relief='solid')
        self.btnClose.place(x=700, y=500)
        self.btnView = tkinter.Button(self.winFrame, text="View",  command=lambda: self.NextWindow(self.method), font=("Times New Roman",10,'bold'),width=20,background="white",fg="black",padx=5,pady=5,borderwidth=1,relief='solid',activeforeground="white",activebackground='gray')
        self.btnView.place(x=400, y=500)
